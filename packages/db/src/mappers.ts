...
export function toProjectAuditJob(job: ProjectAuditJob): CoreProjectAuditJob {
  return {
    ...
    gapProposal: job.gapProposal && typeof job.gapProposal === 'object' ? job.gapProposal as unknown as CoreProjectAuditJob['gapProposal'] : undefined,
    gapProposalStatus: job.gapProposalStatus as CoreProjectAuditJob['gapProposalStatus'],
    gapProposalReview: job.gapProposalReview && typeof job.gapProposalReview === 'object' ? job.gapProposalReview as CoreProjectAuditJob['gapProposalReview'] : undefined,
    gapProposalDecidedAt: job.gapProposalDecidedAt?.toISOString(),
    gapProposalHistory: Array.isArray(job.gapProposalHistory) ? job.gapProposalHistory as unknown as CoreProjectAuditJob['gapProposalHistory'] : [],
