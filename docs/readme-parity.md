...
| Runtime bez approval vetvi; historicke approval zaznamy pouze pro audit | `implemented` | `tested` | `deferred` | `apps/studio-api/src/routes.ts`; `apps/worker/src/workflow.ts`; `packages/db/prisma/migrations/20260831160000_remove_runtime_approvals/migration.sql` |
...
| Repository-grounded planning, resume planningu a nezavisle review roadmapy | `implemented` | `tested` | `deferred` | `apps/studio-api/src/routes.ts`; `apps/studio-api/src/roadmap.test.ts`; `apps/studio-api/src/roadmap-resume.test.ts`; `packages/providers/src/roadmap-review-prompt.test.ts` |
